 ...
 * 查找物料
 * */
public class MatterActivity extends BaseActivity implements OnRecyclerItemClickerListener {
    ...
    public void initShooping(){
        dayadapter=new ShoopingDayBookAdapter(MatterActivity.this);
        recy_answer.setLayoutManager(new GridLayoutManager(MatterActivity.this, 5));
