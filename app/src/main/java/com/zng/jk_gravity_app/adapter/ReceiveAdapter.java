...
public class ReceiveAdapter extends RecyclerView.Adapter<ReceiveAdapter.MViewHolder> {
    ...
    public ReceiveAdapter(Context mContext) {
    ...
    @Override
    public ReceiveAdapter.MViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_FOOTER) {
            return new ReceiveAdapter.MViewHolder(VIEW_FOOTER);
        } else if (viewType == TYPE_HEADER) {
            return new ReceiveAdapter.MViewHolder(VIEW_HEADER);
        } else {
            return new ReceiveAdapter.MViewHolder(getLayout(R.layout.activity_lingyong_item));
        }
    }
    public class MViewHolder extends RecyclerView.ViewHolder {
        TextView text_name,text_title,text_time,text_state,text_wancheng;
        ImageView image_logo_two;
        AutoRelativeLayout line_look_details;
        ...
        MViewHolder(View itemView) {
            ...
            line_look_details= itemView.findViewById(R.id.line_look_details);
...
//            text_wancheng= itemView.findViewById(R.id.text_wancheng);
    ...
    @Override
    public void onBindViewHolder(ReceiveAdapter.MViewHolder holder, int position) {
        if (!isHeaderView(position) && !isFooterView(position)) {
            ...
            holder.line_look_details.setOnClickListener(new View.OnClickListener() {
                @Override
