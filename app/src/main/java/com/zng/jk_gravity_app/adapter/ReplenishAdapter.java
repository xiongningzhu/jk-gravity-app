...
public class ReplenishAdapter extends RecyclerView.Adapter<ReplenishAdapter.MViewHolder> {
    ...
    public ReplenishAdapter(Context mContext) {
    ...
    @Override
    public ReplenishAdapter.MViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_FOOTER) {
            return new ReplenishAdapter.MViewHolder(VIEW_FOOTER);
        } else if (viewType == TYPE_HEADER) {
            return new ReplenishAdapter.MViewHolder(VIEW_HEADER);
        } else {
            return new ReplenishAdapter.MViewHolder(getLayout(R.layout.activity_replenish_item));
        }
    }
...
//            text_wancheng= itemView.findViewById(R.id.text_wancheng);
    ...
    @Override
    public void onBindViewHolder(ReplenishAdapter.MViewHolder holder, int position) {
