...
public class ReplenishAffirmAdapter extends RecyclerView.Adapter<ReplenishAffirmAdapter.MViewHolder> {
    ...
    public ReplenishAffirmAdapter(Context mContext) {
    ...
    public List<RevertBeen> getLists() {
        return lists;
    }

    @Override
    public ReplenishAffirmAdapter.MViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_FOOTER) {
            return new ReplenishAffirmAdapter.MViewHolder(VIEW_FOOTER);
        } else if (viewType == TYPE_HEADER) {
            return new ReplenishAffirmAdapter.MViewHolder(VIEW_HEADER);
        } else {
            return new ReplenishAffirmAdapter.MViewHolder(getLayout(R.layout.activity_replenishaffirm_item));
        }
    }
    public class MViewHolder extends RecyclerView.ViewHolder {
        TextView text_name,text_title,text_time,text_state,text_wancheng;
        AutoLinearLayout line_look;
        AutoRelativeLayout rela_look;
        ...
        MViewHolder(View itemView) {
            ...
            line_look= itemView.findViewById(R.id.line_look);
...
//            text_wancheng= itemView.findViewById(R.id.text_wancheng);
    ...
    @Override
    public void onBindViewHolder(ReplenishAffirmAdapter.MViewHolder holder, int position) {
        if (!isHeaderView(position) && !isFooterView(position)) {
            ...
            holder.remember.setChecked(been.isIsclick());
            holder.remember.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    lists.get(mposition).setIsclick(holder.remember.isChecked());
                    notifyDataSetChanged();
                    onItemClick.onRecyclerItemClick(v, mposition);
                }
            });
            holder.line_look.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onItemClick.onRecyclerItemClick(v, mposition);
                }
